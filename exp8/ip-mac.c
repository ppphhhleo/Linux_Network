/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Mon 16 May 2022 01:07:10 AM PDT
 ************************************************************************/
...
int main ( int argc, char **argv )
{
    ...
    printf ( "\033[1;37;46m本地 IP = [%s] MAC = [%s] \033[0m\n\n",inet_ntoa (*(struct in_addr * ) ip), mac_ntoa(mac));
    // printf("\033[1;37;45m  \033[0m\n");
    //if ( argc==1 ) return ( -1 );
    int i=0;

    for(i=1;i<256;i++)
    {
        sprintf ( dest,"192.168.181.%d",i );
...
*/
    ...
    printf ( "\n\033[1;37;41m 发送ARP请求报文(192.168.181.1~192.168.181.255)完毕：%ld毫秒\033[0m\n", ( tvafter.tv_sec-tvpre.tv_sec ) *1000+ ( tvafter.tv_usec-tvpre.tv_usec ) /1000 );
